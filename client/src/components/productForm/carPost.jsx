    ...
    return(
       ...
       <div className="container">
        <div className="header">
            ...
            <span className="cat">Cars/Cars<a href="#"><b>Change</b></a></span>
            <span className="cat" id="link"></span>
        </div>
        <div className="content">
            <h2 className="head2">INCLUDE SOME DETAILS</h2>
            <div className="labels">
                <label for="brand"  required>brand*</label>
                <select name="brand" id="brand" onChange={handleChangeD}>
                    <option value={des.brand} ></option>
